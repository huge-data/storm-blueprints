...
public class ClickThruAnalyticsTopology {
	...
	public static StormTopology buildTopology() {
		...
		TridentState clickThruState = inputStream
				.each(new Fields("username", "campaign", "product", "click"), new Filter("click", "true"))
		...
		inputStream
				...
				.each(new Fields("campaign", "impression_count", "click_thru_count"), new CampaignEffectiveness(),
						new Fields(""));
