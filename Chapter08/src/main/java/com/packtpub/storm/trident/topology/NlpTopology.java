...
public class NlpTopology {
	...
	public static StormTopology buildTopology() {
		...
		try {
			inputStream
					.each(new Fields("tweet"), new TweetSplitterFunction(), new Fields("word"))
					.each(new Fields("searchphrase", "tweet", "word"), new WordFrequencyFunction(),
							new Fields("baseline"))
					.each(new Fields("searchphrase", "tweet", "word", "baseline"), new PersistenceFunction(),
							new Fields("none"))
					.partitionPersist(new DruidStateFactory(), new Fields("searchphrase", "tweet", "word", "baseline"),
							new DruidStateUpdater());
		} catch (IOException e) {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("SystemMiili = https://api.hmsonline.com/" + contentTosign + "&signature="
